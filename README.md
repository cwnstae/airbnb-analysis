...
In this section we will load the data and explore to see the detail before analysis and find the way to deal with dirty-data and formating it into usable data. the dataset we use is <td>Tableau Full Project.xlsx</td>
